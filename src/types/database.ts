...
export const translations: Record<UILanguage, Record<string, string>> = {
  en: {
    ...
    'home.features_subtitle': 'Teachers, volunteers, and community members sharing resources to ensure no student is left behind—especially in times of crisis.',
  ...
  si: {
    ...
    // Home page
    'home.title': 'ශික්ෂණ කිසිවිටත් අසාර්ථක නොවේ - සිසුන් එකට සිටින විට',
    ...
    'home.features_title': 'දැනුම සමඟ මනුෂ්‍යත්වයව එක්තු කිරීම',
    'home.features_subtitle': 'ගුරුවරුන්, ස්වේච්ඡා සේවකයින් සහ ප්‍රජා සිසුන්ට සහාය වෙමින්. කිසිම සිසුවක් අහිමි නොවිය යුතුය - විශේෂයෙන් අර්බුදකාලීන සමයේ.',
    ...
    'about.contributors_text': 'ඔබ ගුරුවරයෙක්, ශික්ෂණ ශිල්පකාරයෙක්, හෝ විෂය විශේෂඥයෙක්ද? අපගේ දායක ප්‍රජාවට එක්වෙන්න සහ ඉගෙනුම් සිසුන්ට උපකාර කරන්න. ඔබේ සටහන්, පසුගිය ප්‍රශ්න පත්‍ර සහ අධ්‍යාපනික අන්තර්ගතය අපගේ ප්‍රජා සඳහා බෙදා ගන්න.',
    'about.submit_resource': 'සම්පතුව ඉදිරිපත් කරන්න',
  ...
  ta: {
    ...
    'home.features_title': 'அறிவின் மூலம் மானபதை ஐக்கியப்படுத்துதல்',
    'home.features_subtitle': 'ஆசிரியர்கள், தன்னார்வலர்கள் மற்றும் சமூக உறுப்பினர்கள் மாணவர்களுக்கு ஆதரவு வழங்குகின்றனர். எந்த மாணவரும் பின்தங்கி விடக்கூடாது - குறிப்பாக நெருக்கடி சமயங்களில்.',
