...
export const translations: Record<UILanguage, Record<string, string>> = {
  en: {
    ...
    'about.contact_email': 'contact@kuppihub.org',
  ...
  si: {
    ...
    'submit.description_placeholder': 'ඒ ගැන කුඩා විස්තරයක්..',
    'submit.url': 'URL / ලින්ක් එක ',
    'submit.url_hint_material': 'PDF, Google Drive, හෝ වෙනත් ගොනු සත්කාරකයට ලින්ක් එක',
    ...
    'submit.button': 'ඇතුලත් කරන්න',
    'submit.submitting': 'අප්ලෝඩ් වෙමින්...',
    'submit.success': 'ඇතුලත් කිරීම සාර්තකයි. ගොඩක් ස්තුතියි ඔයාට!',
    'submit.success_pending': 'ඇතුලත් කිරීම සාර්තකයි. ගොඩක් ස්තුතියි ඔයාට! අපි මේක Approve කරනවා.',
    'submit.success_approved': 'දැන් මෙය සජීවීව සිසුන්ට ලබා දී ඇත.',
    'submit.error': 'මොකක් හරි අවුලක් වෙලා. නැවත උත්සාහ කරන්න.',
    
    // Dashboard
    'dashboard.welcome': 'ආයුබෝවන්, {name}',
    'dashboard.subtitle': 'ඔබ ගේ Dashboard එක',
    'dashboard.total': 'මුළු Resources',
    'dashboard.materials': 'පේපර්/නෝට්ස්',
    'dashboard.sessions_count': 'වීඩියෝ/පන්ති',
    'dashboard.pending': 'අනුමැතිය බලාපොරොත්තුවෙන්',
    'dashboard.add_new': 'තව එකක් ඇඩ් කරන්න',
    'dashboard.add_new_desc': 'නව ප්‍රශ්න පත්‍රයක්, සටහනක් හෝ පන්තියක් එකතු කරන්න',
    'dashboard.manage': 'Dashboard කළමනාකරණය',
    'dashboard.manage_desc': 'ඔබේ ඇතුලත් කල දෙයක් සංස්කරණය හෝ මකන්න',
